...
#ifndef __USBH_CUSTOM_AUDIO_H
#define __USBH_CUSTOM_AUDIO_H
...
typedef struct _AUDIO_Process {
    ...
    // uint8_t *audio_in_buffer;  // Dynamically allocated buffer
} AUDIO_HandleTypeDef;
 ...
 * @{
 */
extern USBH_ClassTypeDef CUSTOM_AUDIO_Class;
#define USBH_CUSTOM_AUDIO_CLASS &CUSTOM_AUDIO_Class
/**
 * @}
 */
